        ...
        >
          {isSearching ? (
            filteredCategories.length === 0 ? (
              <p className="text-center text-stone-500 py-8 mb-16">
                ...
                {filteredCategories.map((category, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="w-28 h-28 sm:w-36 sm:h-36 mt-6 mb-2 z-10 shadow-[0_8px_30px_rgb(0,0,0,0.1)] overflow-hidden bg-[#FAF8F5] transition-all duration-700 ease-in-out rounded-[64%_36%_27%_73%/55%_58%_42%_45%] group-hover:rounded-[33%_67%_58%_42%/63%_68%_32%_37%]">
                        <img
                          src={category.image}
                          alt={category.name}
              ...
              {[...CATEGORIES, ...CATEGORIES, ...CATEGORIES].map((category, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    {/* View Menu Button (Appears on Hover or active card on mobile) */}
                    <div className={`absolute bottom-5 left-0 right-0 px-6 transition-all duration-300 z-10 ${isActive ? 'opacity-100 translate-y-0 pointer-events-auto' : 'opacity-0 translate-y-3 pointer-events-none'} group-hover:opacity-100 group-hover:translate-y-0 group-hover:pointer-events-auto`}>
                      <div className="w-full h-[36px] flex items-center justify-center bg-[#222222] text-white text-[13px] font-bold rounded-full shadow-md">
                        View Menu
                      </div>
